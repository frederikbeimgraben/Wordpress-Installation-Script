...
# -*- coding: utf-8 -*-
"""
Create a docker compose project for a wordpress site running behind a reverse proxy
"""
        ...
        while True:
            try:
                try:
                    ...
                    if not latch:
                        return False, f'Waiting for DNS to resolve for {hostname}. Press CTRL+C to proceed without waiting...'
                        latch = True
                    time.sleep(1)
